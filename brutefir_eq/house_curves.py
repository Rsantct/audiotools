...
"""
    ...
    house_curves.py  -RXX  -fsXX  -loSX  -loGX -hiGX -loFX -hiFX  --save  --plot
        ...
        -loSX:  6 | 12  low shelf slope (default: X=6, 1st order 6 dB/oct)

        -loFX:  Low shelf center frequency (default: X=120 Hz)

        -loGX:  Low shelf gain dB (default: 0 to +6.0 dB, 1 dB step)

        -hiFX:  High roll-off corner frequency (default: X=500 Hz)

        -hiAX:  High roll-off end atten dB (default: from 0 to -6.0 dB, 1 dB step)
    ...
    for opc in sys.argv[1:]:
        ...
        if opc == '-h' or opc == '--help':
            ...
            if value >= 250 and value <= 10000:
                ...
                raise ValueError('Hi roll-off corner between 250 ... 10000 Hz')
